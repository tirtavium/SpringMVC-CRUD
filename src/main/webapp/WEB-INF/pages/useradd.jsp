...
<form:form method="POST" commandName="ucd">
...
<td>Job : </td>
<td>
<form:select path="job" items="${jobList}" multiple="true" />
</td>
...
<p><a href="${pageContext.request.contextPath}/index"><button class="button2">Back</button></a></p>
</div>
</body>
